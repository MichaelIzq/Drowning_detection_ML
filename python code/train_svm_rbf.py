...
def main():
    ...
    ap.add_argument("--out", default="best_svm_rbf_threshold.joblib")
    ...
    model = SVC(kernel="rbf", probability=True, C=2, gamma="scale")
    ...
    plt.xlabel("Predicted"); plt.ylabel("True"); plt.title("RBF SVM (Thresholded) Confusion")
    plt.tight_layout(); plt.savefig("confusion_svm_rbf_threshold.png", dpi=150)
...
"""
# RBF SVM
& "E:/Program Files/Python/python.exe" "E:/documents/Thesis code/train_svm_rbf.py" `
  --in "E:/documents/Thesis code/features/all_strokes_combined.csv" `
  --out "E:/documents/Thesis code/models/best_svm_rbf_threshold.joblib" `
  --threshold 0.6
