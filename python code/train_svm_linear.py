...
def main():
    ...
    ap.add_argument("--out", default="best_svm_linear_threshold.joblib")
    ...
    plt.xlabel("Predicted"); plt.ylabel("True"); plt.title("Linear SVM (Thresholded) Confusion")
    plt.tight_layout(); plt.savefig("confusion_svm_linear_threshold.png", dpi=150)
...
"""# Linear SVM
& "E:/Program Files/Python/python.exe" "E:/documents/Thesis code/train_svm_linear.py" `
  --in "E:/documents/Thesis code/features/all_strokes_combined.csv" `
  --out "E:/documents/Thesis code/models/best_svm_linear_threshold.joblib" `
  --threshold 0.6
  """