...
def main():
    ...
    ap.add_argument("--out", default="best_tree_threshold.joblib")
    ...
    model = DecisionTreeClassifier(max_depth=8, min_samples_leaf=3, random_state=42)
    model.fit(X_train, y_train)

    # Decision Tree predict_proba exists
    ...
    plt.xlabel("Predicted"); plt.ylabel("True"); plt.title("Decision Tree (Thresholded) Confusion")
    plt.tight_layout(); plt.savefig("confusion_tree_threshold.png", dpi=150)
...
"""
# Decision Tree
& "E:/Program Files/Python/python.exe" "E:/documents/Thesis code/train_decisiontree.py" `
  --in "E:/documents/Thesis code/features/all_strokes_combined.csv" `
  --out "E:/documents/Thesis code/models/best_tree_threshold.joblib" `
  --threshold 0.6
  """